...
app = Flask(__name__)
CORS(app)
os.environ["OPENAI_API_KEY"] = "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"
chat_history = []
...
def read_csv(csv_folder_path):
    ...
    csv_documents = [Document(page_content=content, metadata={'source': csv_file}) for content in
                     csv_texts]  # 'source' 메타데이터 추가
...
file_encoding_lst('./data')
check_csv_encoding('./data')  # CSV 파일들의 인코딩 확인
folder_path = './data'
